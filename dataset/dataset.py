...
from utils.utils import as_intrinsics_matrix
from torch.utils.data import Dataset, Sampler

def get_dataset(cfg, args, scale, device='cuda'):
    '''
    Return the dataset class, defining in config file. 
    '''
...
class BaseDataset(Dataset):
    ...
    def __init__(self, cfg, args, scale, device='cuda'):
        ...
        self.crop_size = cfg['cam'].get('crop_size') if args.light else None
    ...
    def __getitem__(self, index):
        ...
        return {'color': color_data, 'depth': depth_data, 'pose': pose}

class Replica(BaseDataset):
    '''
    Son class for Replica scene, inheriting from BaseDataset
    '''
    def __init__(self, cfg, args, scale, device='cuda'):
